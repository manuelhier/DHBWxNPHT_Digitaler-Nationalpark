...
1. BIOS Nationalparkzentrum Mallnitz (Kärnten)
   ...
   **Rangerlab:** „rangerlabs BIOS Mallnitz" – gemeinsames Forschen und Experimentieren mit Rangern
   **Eintritt:** kostenlos mit Kärnten Card und Nationalpark Partnerkarte

2. Nationalparkwelten Mittersill (Salzburg)
   **Adresse:** Nationalparkzentrum Mittersill (Salzburg)
   **Ausstellung:** Acht Themen-Welten – vom 3D-Kino über Entstehung der Alpen bis zur Gletscherwelt
   360-Grad-Panoramawelt: HD-Projektionstechnik mit Natur- und Gipfelerlebnissen aus dem Nationalpark
   Eignet sich als Einstieg für Nationalpark-Besuche auf Salzburger Seite
...
4. Science Center Mittersill (Salzburg)
   **Schwerpunkt:** Experimentieren mit naturwissenschaftlichen Fragestellungen
   **Zielgruppe:** Schulklassen und Familien

5. Nationalparkwerkstatt Hollersbach (Salzburg)
   **Ort:** Klausnerhaus, Hollersbach
   **Konzept:** Natur und Kultur des Nationalparks mit allen Sinnen erleben

6. Haus des Wassers (Tirol)
...
**Zielgruppe:** Erwachsene (Lehrpersonen, Naturinteressierte, Ranger-Anwärter, Wissenschaftler)
**Sitz (Tirol):** Kirchplatz 2, A-9971 Matrei i.O.
...
1. Greifvogelmonitoring
   **Arten:** Bartgeier, Steinadler, Gänsegeier, Mönchsgeier
   **Maßnahmen:** Brutbestandserfassung, Meldung von Sichtungen, Beringung
   **Besonderheit:** Der NPHT ist das einzige Gebiet in Mitteleuropa mit regelmäßig wildlebenden Geiern

2. Gewässermonitoring
   **Gegenstand:** Wasserqualität, Wasserführung und ökologischer Zustand der Gebirgsbäche und -seen
   **Daten:** ktntv.at (Wasserstandsdaten)

3. Schalenwildmonitoring
   **Arten:** Steinbock, Gämse, Rotwild
   **Ziel:** Bestandserfassung und Grundlage für nachhaltiges Wildtiermanagement

4. Forellenmonitoring
   **Zielobjekt:** Urforelle (Salmo trutta, Donau-Typus)
   **Ziel:** Bestandserhalt dieser bedrohten, genetisch ursprünglichen Forelle

5. Biodiversitätsforschung
   **Gegenstand:** Erfassung und Monitoring der Artenvielfalt in Flora und Fauna
   **Werkzeug:** Vegetationskartierung, Langzeitmonitoring

6. Langzeitmonitoring & Vegetationskartierung
   **Laufendes Projekt (2024–2027):** Almnutzungserhebung in Kärnten und Salzburg
   **Ziel:** Erfassung aktueller Lebensraumtypen und Almnutzung; Kartierarbeiten Sommer 2026, Auswertung bis Mai 2027

7. Klimaforschung & Gletschermonitoring
   **Pasterze:** Älteste laufende Gletschermessreihe Österreichs (seit 1879)
...
- parcts.at – Wissenschaftliche Datensätze des Nationalparks (Forschungsgrundlagen)
- geosphere.at – Klimadaten, Messdaten Hoher Sonnblick (GeoSphere Austria)
- ktntv.at – Wasserstandsdaten der Kärntner Gewässer
...
- E.C.O. Institut für Ökologie (Klagenfurt): Ökologische Forschung und Beratung
- Universität Graz: Gletscherforschung (Gerhard Lieb, Andreas Kellerer-Pirklbauer)
